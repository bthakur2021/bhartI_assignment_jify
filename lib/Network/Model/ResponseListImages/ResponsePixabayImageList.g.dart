...
_$_ResponsePixabayImageList _$$_ResponsePixabayImageListFromJson(
        Map<String, dynamic> json) =>
    _$_ResponsePixabayImageList(
      id: json['id'] as int?,
...
Map<String, dynamic> _$$_ResponsePixabayImageListToJson(
        _$_ResponsePixabayImageList instance) =>
    <String, dynamic>{
      'id': instance.id,
